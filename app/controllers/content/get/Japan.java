 ...
 */
public final class Japan extends Controller {

    private static final Log LOG = LogFactory.getLog(Japan.class);

    private static final String GET_JAPAN_SQL = "select t1.japan, t2.name, t1.period, t1.content" +
            " from horo_japans t1, horo_uploads t2 where t1.icon_id=t2.id and upjapan=?";
    ...
    public static Result index() {
        ...
        try {
            ...
            if (json == null) {
                ...
                final PreparedStatement statement = DB.getConnection().prepareStatement(GET_JAPAN_SQL);
