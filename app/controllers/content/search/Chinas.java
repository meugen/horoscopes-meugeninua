 ...
 */
public final class Chinas extends Controller {

    private static final Log LOG = LogFactory.getLog(Chinas.class);
    ...
    public static Result index() {
        Result result;
        try {
            final PreparedStatement statement = DB.getConnection().prepareStatement(SEARCH_CHINAS_SQL);
