 ...
 */
public final class Flowers extends Controller {

    private static final Log LOG = LogFactory.getLog(Flowers.class);
    ...
    public static Result index() {
        Result result;
        try {
            final PreparedStatement statement = DB.getConnection().prepareStatement(SEARCH_FLOWERS_SQL);
