 ...
 */
final class GetChinaHelper extends AbstractJsonControllerHelper {

    private static final Log LOG = LogFactory.getLog(GetChinaHelper.class);
     ...
     * @param json Json
     */
    public GetChinaHelper(final JsonNode json) {
        super(json, new String[] { PARAM_CHINA });
    }
        ...
        try {
            result = DatabaseHelper.actionWithStatement(new DatabaseHelper.StatementAction<JsonNode>() {
                public JsonNode onAction(PreparedStatement statement) throws SQLException {
                    return GetChinaHelper.this.internalAction(statement, json);
                }
            }, GET_CHINA_SQL);
        } catch (Exception e) {
