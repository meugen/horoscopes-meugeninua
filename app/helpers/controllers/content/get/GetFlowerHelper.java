 ...
 */
final class GetFlowerHelper extends AbstractJsonControllerHelper {

    private static final Log LOG = LogFactory.getLog(GetFlowerHelper.class);
     ...
     * @param json Json
     */
    public GetFlowerHelper(final JsonNode json) {
        super(json, new String[] { PARAM_FLOWER });
    }
        ...
        try {
            result = DatabaseHelper.actionWithStatement(new DatabaseHelper.StatementAction<JsonNode>() {
                public JsonNode onAction(PreparedStatement statement) throws SQLException {
                    return GetFlowerHelper.this.internalAction(statement, json);
                }
            }, GET_FLOWER_SQL);
        } catch (Exception e) {
