...
public final class GetHelpersFactory {
    ...
    public static ControllerHelper newGetFlowerHelper(final JsonNode json) {
        final SimpleGetHelper helper = new SimpleGetHelper(json);
    ...
    public static ControllerHelper newGetNameHelper(final JsonNode json) {
        final SimpleGetHelper helper = new SimpleGetHelper(json);
    ...
    public static ControllerHelper newGetJapanHelper(final JsonNode json) {
        final SimpleGetHelper helper = new SimpleGetHelper(json);
    ...
    public static ControllerHelper newGetHoroscopeHelper(final JsonNode json) {
        return new GetHoroscopeHelper(json);
    }

    public static ControllerHelper newGetHoroscopeHelper(final JsonNode json, final String period) {
        final GetHoroscopeHelper helper = new GetHoroscopeHelper(json);
