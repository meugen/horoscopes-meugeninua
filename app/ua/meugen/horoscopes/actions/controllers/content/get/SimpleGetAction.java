 ...
 */
final class SimpleGetAction extends AbstractJsonControllerAction {

    private static final Logger.ALogger LOG = Logger.of(SimpleGetAction.class);
     ...
     * @param json Json
     */
    public SimpleGetAction(final JsonNode json) {
        super(json);
    }
