...
abstract class AbstractInterpretationSearchAction<Dto>
        extends AbstractJsonControllerAction<ItemsResponse<Dto>, SearchInterpretationRequest> {
    ...
    protected final Result action(final SearchInterpretationRequest request) {
        ...
        try {
            ...
            result = Controller.internalServerError(this.newErrorResponse(e).asJson());
        }
        return result;
    }
    ...
    private ItemsResponse<Dto> internalAction(final PreparedStatement statement,
        ...
        try (ResultSet resultSet = statement.executeQuery()) {
            ...
            final ItemsResponse<Dto> response = this.newOkResponse();
