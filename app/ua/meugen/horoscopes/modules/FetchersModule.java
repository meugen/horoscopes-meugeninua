...
public final class FetchersModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(new TypeLiteral<EntityToDtoFetcher<China, SimpleDto>>(){})
                .to(ChinaItemToDtoFetcher.class);
        bind(new TypeLiteral<EntityToDtoFetcher<Druid, SimpleDto>>(){})
                .to(DruidItemToDtoFetcher.class);
        bind(new TypeLiteral<EntityToDtoFetcher<Flower, SimpleDto>>(){})
                .to(FlowerItemToDtoFetcher.class);
        bind(new TypeLiteral<EntityToDtoFetcher<Japan, SimpleDto>>(){})
                .to(JapanItemToDtoFetcher.class);
    }
}
