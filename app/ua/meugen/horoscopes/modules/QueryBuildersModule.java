...
public final class QueryBuildersModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(new TypeLiteral<QueryBuilder<China, String>>(){})
                .to(SearchChinasBuilder.class);
        bind(new TypeLiteral<QueryBuilder<Flower, String>>(){})
                .to(SearchFlowersBuilder.class);
        bind(new TypeLiteral<QueryBuilder<Druid, String>>(){})
                .to(SearchDruidsBuilder.class);
        bind(new TypeLiteral<QueryBuilder<Japan, String>>(){})
                .to(SearchJapansBuilder.class);
    }
}
